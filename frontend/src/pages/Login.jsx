      ...
      <div className="login-right">
        <div className="login-form-wrap fade-in">
          ...
          <div style={{
            ...
            background: 'var(--gris-10)', borderRadius: 10,
            fontSize: '.74rem', color: 'var(--texto-claro)',
            display: 'flex', alignItems: 'flex-start', gap: 8,
          }}>
            <IcoLock style={{ flexShrink: 0, marginTop: 1 }} />
