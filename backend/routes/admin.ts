...
import { RequestAutenticado, Requisicion, Usuario, RegistroAuditoria } from '../types.js';
...
router.get(
  ...
  async (_req: RequestAutenticado, res: Response): Promise<void> => {
...
router.delete(
  '/requisiciones/:id',
  soloAdmin as unknown as Router,
