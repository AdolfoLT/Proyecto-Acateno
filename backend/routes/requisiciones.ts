...
import { RequestAutenticado, Requisicion, Area, Clasificacion, FormaPago } from '../types.js';
...
router.get('/catalogos/areas', async (_req, res: Response): Promise<void> => {
  try {
...
router.get('/catalogos/clasificaciones', async (_req, res: Response): Promise<void> => {
  try {
...
router.get('/', async (req: RequestAutenticado, res: Response): Promise<void> => {
  try {
...
router.get('/:id', async (req: RequestAutenticado, res: Response): Promise<void> => {
  try {
    const [rows] = await pool.query<Requisicion[] & mysql.RowDataPacket[]>(
...
router.post('/', async (req: RequestAutenticado, res: Response): Promise<void> => {
  const {
...
router.put('/:id', async (req: RequestAutenticado, res: Response): Promise<void> => {
  const {
    area_id, area_nombre, clasificacion_id,
    concepto, proveedor, rfc, monto,
    forma_pago, cuenta_bancaria, no_factura, no_contrato, fecha,
...
router.delete(
  '/:id',
  adminOContador as unknown as Router,
  async (req: RequestAutenticado, res: Response): Promise<void> => {
